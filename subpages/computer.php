...
<section>
    <?php
    $sql = "SELECT * FROM games WHERE GameType = 'computer';";
        ...
        echo '<body>
            <table cellspacing="0">
                <tr class="computer row">
                    ...
                    <th class="column-name sixth column display920"><span>platformy</span></th>
                    <th class="column-name seventh column display500"><span>rok wydania</span></th>
